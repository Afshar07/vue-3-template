<template>
  <div class="drawer drawer-mobile h-full    "
       :class="{'!z-[99] fixed':sideBarStore.showSideBar,'!z-[1]':!sideBarStore.showSideBar}">
    <input id="my-drawer-2" type="checkbox" class="drawer-toggle"/>
    <div class="drawer-side shadow-2xl w-full h-full">
      <label ref="sideBarLabel" @click="countTouch" for="my-drawer-2" class="drawer-overlay h-full"></label>
